...
import com.example.dmitry.videoeditor.MainActivity;
...
public class HorizontalImagesScrallFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_horizontal_images_scrall, container, false);
        LinearLayout itemsContainer =
                ( LinearLayout)(rootView.findViewById(R.id.fragment_horizontal_images_scrall_list));
        ...
        getActivity().findViewById(R.id.fragment_image_ok_button).setVisibility(View.VISIBLE);
        for(int i = 0; i <  bms.length; i++) {
            View view = inflater.inflate(R.layout.item_image_with_text_fix_width, null);
            ((ImageView)(view.findViewById(R.id.image_with_text_icon))).setImageBitmap(bms[i]);
            ((TextView)(view.findViewById(R.id.image_with_text_text))).setText(sts[i]);
